...
public class ExampleGrpcGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.hgldp.grpc1.HelloRequest,
      com.hgldp.grpc1.HelloResponse> METHOD_SEND_SIMPLE_MESSAGE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "ExampleGrpc", "sendSimpleMessage"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.HelloRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.HelloResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.hgldp.grpc1.HelloRequest,
      com.hgldp.grpc1.StudentResponse> METHOD_GET_LIST_MESSAGE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING,
          generateFullMethodName(
              "ExampleGrpc", "getListMessage"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.HelloRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.StudentResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.hgldp.grpc1.HelloRequest,
      com.hgldp.grpc1.StudentResponseList> METHOD_GET_STUDENT_LIST =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING,
          generateFullMethodName(
              "ExampleGrpc", "getStudentList"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.HelloRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.StudentResponseList.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.hgldp.grpc1.StreamRequest,
      com.hgldp.grpc1.StreamResponse> METHOD_BI_TALK =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "ExampleGrpc", "BiTalk"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.StreamRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.hgldp.grpc1.StreamResponse.getDefaultInstance()));
  ...
  public static abstract class ExampleGrpcImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendSimpleMessage(com.hgldp.grpc1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hgldp.grpc1.HelloResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_SEND_SIMPLE_MESSAGE, responseObserver);
    }

    /**
     */
    public void getListMessage(com.hgldp.grpc1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hgldp.grpc1.StudentResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_LIST_MESSAGE, responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<com.hgldp.grpc1.HelloRequest> getStudentList(
        io.grpc.stub.StreamObserver<com.hgldp.grpc1.StudentResponseList> responseObserver) {
      return asyncUnimplementedStreamingCall(METHOD_GET_STUDENT_LIST, responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<com.hgldp.grpc1.StreamRequest> biTalk(
        io.grpc.stub.StreamObserver<com.hgldp.grpc1.StreamResponse> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.hgldp.grpc1.HelloRequest,
                com.hgldp.grpc1.HelloResponse>(
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.hgldp.grpc1.HelloRequest,
                com.hgldp.grpc1.StudentResponse>(
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                com.hgldp.grpc1.HelloRequest,
                com.hgldp.grpc1.StudentResponseList>(
                  this, METHODID_GET_STUDENT_LIST)))
          .addMethod(
            METHOD_BI_TALK,
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.hgldp.grpc1.StreamRequest,
                com.hgldp.grpc1.StreamResponse>(
  ...
  public static final class ExampleGrpcBlockingStub extends io.grpc.stub.AbstractStub<ExampleGrpcBlockingStub> {
    ...
    /**
     */
    public com.hgldp.grpc1.HelloResponse sendSimpleMessage(com.hgldp.grpc1.HelloRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.hgldp.grpc1.StudentResponse> getListMessage(
        com.hgldp.grpc1.HelloRequest request) {
  ...
  public static final class ExampleGrpcFutureStub extends io.grpc.stub.AbstractStub<ExampleGrpcFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hgldp.grpc1.HelloResponse> sendSimpleMessage(
        com.hgldp.grpc1.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_SIMPLE_MESSAGE:
          serviceImpl.sendSimpleMessage((com.hgldp.grpc1.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hgldp.grpc1.HelloResponse>) responseObserver);
          break;
        case METHODID_GET_LIST_MESSAGE:
          serviceImpl.getListMessage((com.hgldp.grpc1.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hgldp.grpc1.StudentResponse>) responseObserver);
          break;
        default:
